...
if(isset($_REQUEST['login']))
{
  ...
  $loginsql="select * from admin_login where username='$username' and password='$password' ";
  $reslogin=mysqli_query($conn,$loginsql);
  ...
  {
    print "<center><h1 style='color:red'> user password dose not match</h1></center>";
  }
}
